...
export default function BackToPrev({ href, children }) {
    return (
        <a 
            href={href} 
            className="relative group w-fit flex pl-7 pr-3 py-1.5 flex-nowrap rounded-xl border border-black/15 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/5 hover:text-black dark:hover:text-white transition-colors duration-300 ease-in-out"
        >
            <svg 
